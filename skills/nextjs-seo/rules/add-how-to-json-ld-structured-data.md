...
description: Learn how to add HowTo JSON-LD structured data to a page using standard Next.js features.
---

Next.js natively supports adding HowTo JSON-LD structured data to a page.
